...
for executing applications directly on the login node. We used HTBAC version 0.1,
EnTK version 0.6, and RP version 0.47. The MD engine used is NAMD-MPI on Blue 
Waters. On Titan the MD engine is non-MPI multi-core NAMD compiled with CUDA. 

We show homogeneous and heterogeneous weak scalability of the ESMACS 
...
indicated in Figure~\ref{fig:weak_scaling_TIES} because the NAMD executable used in all tasks
