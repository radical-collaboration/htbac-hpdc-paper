...
\begin{figure}
  ...
  that reproducibility of free energy calculations can be achieved up to \SI{0.2}{\kilo\calorie\per\mole}. The adaptive algorithm brings down the error of the non-adaptive
