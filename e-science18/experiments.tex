...
system and the weak and strong scaling performance on NCSA Blue Waters. We then 
perform adaptive experiments of several ligands to characterize improvements in 
time-to-convergence. 
...
by half in each run. We measure how the timing of the workload scale when adding 
resources, while expecting fixed overheads in HTBAC, EnTK and RP. Experiments 4 
...
Due to the NCSA 
% and ORNL 
security policies, we performed the Blue Waters
experiments from a persistent virtual machine 
