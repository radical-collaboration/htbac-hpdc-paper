...
Even at small scale it is hard to implement adaptive algorithms that use common molecular dynamics simulations engines (e.g., NAMD, Gromacs, Amber). This is in part because of the way the scientist interacts with these codes. The user
...
schemes to increase convergence rate and more obtain accurate results scientific
results.
...
is written conflates effect with driver.} 
