...
Figure~\ref{fig:adapconv} compares the error on the adaptive and non-adaptive
...
\begin{figure}
  ...
  lowered. This is a plot for one of the systems.}\label{fig:adapconv}
\up{}
\up{}
\end{figure}
...
\begin{figure}
  ...
  the simulation. \jhanote{Reviwer will want to know what happens with
  remaining two candidates?}\kfnote{Results are in the table for all the
  systems.}}\label{fig:termination}
\end{figure}
