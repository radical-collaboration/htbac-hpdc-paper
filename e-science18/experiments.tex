...
statistical convergence given a defined number of resources. We perform 
comparison experiments between nonadaptive and adaptive methods to characterize
computational efficiency. 


% Highlighted sections below will go in Section III and Section IV
...
% insight 
    Experiment 1 measures the weak scalability of HTBAC, EnTK and RP using multiple 
instances of the ESMACS protocols. Experiment 2 measures weak scaling 
performance of TIES. Experiments 3 repeats the same design as experiments 1 and 2 using the
...
Lastly, we perform adaptivity experiments using the TIES protocol to demonstrate
intra-protocol adaptivity where we shift computational resources during runtime.
We compare results with nonadaptive experiments...  
\jdnote{define intra-protocol adaptivity in section IV}
