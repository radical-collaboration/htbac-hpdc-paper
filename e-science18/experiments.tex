...
Table~\ref{tab:experiments} shows 8 experiments we designed to characterize
...
BRD4 physical systems provided by GlaxoSmithKline, while experiments 6--8 
...
number of protocol instances increases, suggesting that HTBAC is invariant to the protocol. We conclude that HTBAC shows near-ideal weak scaling behavior under these conditions. 
