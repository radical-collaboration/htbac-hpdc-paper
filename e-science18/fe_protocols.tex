...
However, the number (or the exact location) of the $\lambda$ windows that will 
...
% Consequently, whereas in ESMACS replicas run simulations 
% on samples using the same system description, in TIES replicas sample at 
