...
sampled\jdnote{@dww which citation goes well with this? 
the wang2015 paper only mentions FEP}.
...
sampling techniques such as REST \jdnote{@dww which citation goes well with this? 
the wang2015 paper only mentions FEP}.
