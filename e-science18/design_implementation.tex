...
algorithm \mtnote{which algorithm? This paragraph seems disconnected
...
these resources should be available to execute the application \mtnote{what
is the relation among protocol, simulation and application?}.
...
protocols, and acquires resources via a runtime system.\mtnote{The runner
here seems to be a component: it initializes, holds, submits, etc.}
...
\mtnote{The following is part of design. I would move it up and collate. See
my comment in the previous subsection asking for the relation between
protocol and application. I did not understand that relation until I read the
following.} 
...
workflow?}\mtnote{It doesn't but it is on us to define the relation between
an application and a workflow.}
...
feel free to revert if I did not get it right.}
...
Figure~\ref{fig:ties_esmacs_application} demonstrates the implementation of
