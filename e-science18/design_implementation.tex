...
diagram} shows the components (orange) and subcomponents (green) of HTBAC,
...
(which is a continuous iteration is: \href{https://docs.google.com/drawings/d
...
% \begin{figure}
%   \centering
%   \includegraphics[width=\columnwidth]{figures/Component_Subcomponent_Diagr
%   am.pdf}
%   \caption{Components and subcomponents of HTBAC. The protocol, simulation
%   and runner are the main components. The protocol and simulation
%   components describe the protocols and their simulation conditions. The
%   runner component serves as the application manager by interfacing with
%   the ensemble management system.}
...
\jdnote{I created another section that comes after this section that shows the
code for esmacs (nonadaptive) and TIES (intra-protocol adaptivity)}
...
Once an adaptive or nonadaptive workflow is described in HTBAC
...
stages of tasks (Figure~\ref{fig:architecture}.2). The Application Generator 
...
The Application Generator passes the protocol description to the Protocol
