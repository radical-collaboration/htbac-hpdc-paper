...
The application description is passed to the Application Manager of the
Runner component (Figure~\ref{fig:architecture}.2). The Application Manager
...
The Connector subcomponent of the Runner gets the application description
