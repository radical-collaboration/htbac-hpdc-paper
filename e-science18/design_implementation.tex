...
utilize the simulation and analysis components of HTBAC to create any
...
In~\ref{lst:esmacs.py}, we provide the encoding of an ESMACS protocol
instance using HTBAC, showing a customization of simulation conditions for a
minimization step.
