...
one?}\jdnote{keeping it general to campaigns} which requires the ability to
...
thereby requires an adaptive execution strategy \mtnote{system}
\jdnote{changed from adaptive RTS to adaptive execution strategy} that
...
`In' (instead of `of') HTBAC?}\jdnote{addressed} using the following
