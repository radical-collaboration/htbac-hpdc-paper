Ensemble-based binding free energy protocols provide an efficient method for 
...
% systems impact the optimal protocol choice for different proteins and classes of 
...
% We show 
% ideal weak scaling behavior reaching scales of 21120 cores. 
...
% concurrently on more than 16,000 cores. This permits a rapid time-to-solution 
% that is essentially invariant with respect to the calculation protocol, size of 
% target system and number of ensemble simulations. (ii) The validation of binding 
% free energies computed using HTBAC with both experimental and previously 
% published computational results; (iii) HTBAC enabled the adaptive execution of 
% the TIES protocol providing greater convergence (i.e., lower errors) for a given 
% amount of computational resources. To the best of our knowledge, adaptive TIES 
% protocols have not been benchmarked against non-adaptive implementations.
