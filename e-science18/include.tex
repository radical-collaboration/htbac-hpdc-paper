...
\ifdraft{}
  ...
  \newcommand{\jdnote}[1]{ {\textcolor{violet} { ***jumana: #1 }}}
  \newcommand{\dwwnote}[1]{ {\textcolor{cyan} { ***dave: #1 }}}
  \newcommand{\kfnote}[1]{ {\textcolor{green!60!black} { ***kristof: #1 }}}
\else
  \newcommand{\amnote}[1]{}
  \newcommand{\jhanote}[1]{}
  \newcommand{\mtnote}[1]{}
...
\else
  \DeclareGraphicsExtensions{.png, .jpg, .ps}
\fi
