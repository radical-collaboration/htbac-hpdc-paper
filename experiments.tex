...
constant ratio between protocol instances and resources used} \jdnote{will modify once we get new data in the early a.m.} As the number of
...
\begin{figure}
  ...
  nitpick: Is it possible to plot the bars equal widths?}\jdnote{will do}}
