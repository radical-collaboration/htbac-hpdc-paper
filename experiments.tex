...
All \href{https://github.com/radical-experiments/isc-htbac-experiments}{\textcolor{blue}{experimental data}}
use \href{https://github.com/jdakka/radical.htbac/tree/master}{\textcolor{blue}{HTBAC version 0.1}},
...
\end{axis}
\end{tikzpicture}
\caption{Approximating the intergral under the curve, hence calculating $\Delta
\Delta$G. The adaptive algorithm reevaluates the efficiency of the lambda window
