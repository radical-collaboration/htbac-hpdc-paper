...
limited software solutions that can support the scalable execution of
heterogeneous computational tasks. HTBAC builds upon established middleware
solutions~\cite{,}, validated runtime abstractions~\cite{} for scalable
execution of heterogeneous computational tasks, and customizes them for the
computation of binding free energies.


% We designed HTBAC in response to aforementioned challenges and requirements,
% and the 

% that overcome absence of middleware systems that provide scalable and
% extensible and
...
% HTBAC uses the PST model to encode \textbf{Protocols}.
...
alongside their dependencies as a \textbf{pipeline}. HTBAC allows the simple
...
hitherto unavailable capabilities, viz., the adaptive forumation/expression
...
invariant of the specific protocol..... \jhanote{connective tissue for
Experiments Section...}
